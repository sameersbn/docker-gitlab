...
```bash
docker run --name gitlab -it --rm [OPTIONS] \
    sameersbn/gitlab:10.3.5 app:rake gitlab:backup:restore BACKUP=1515629493_2018_01_11_10.3.5
```
...
docker-compose run --rm gitlab app:rake gitlab:backup:restore BACKUP=1515629493_2018_01_11_10.3.5 # Choose to restore from 1515629493
```
