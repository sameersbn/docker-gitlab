...
As an example this code has been tested with Keycloak, with the following variables: `OAUTH2_OPENID_LABEL`, `OAUTH2_OPENID_ICON`, `OAUTH2_OPENID_SCOPE`, `OAUTH2_OPENID_RESPONSE_TYPE`, `OAUTH2_OPENID_ISSUER`, `OAUTH2_OPENID_DISCOVERY`, `OAUTH2_OPENID_CLIENT_AUTH_METHOD`, `OAUTH2_OPENID_UID_FIELD`, `OAUTH2_OPENID_SEND_SCOPE_TO_TOKEN_ENDPOINT`, `OAUTH2_OPENID_CLIENT_OPTIONS_IDENTIFIER`, `OAUTH2_OPENID_CLIENT_OPTIONS_SECRET` and `OAUTH2_OPENID_CLIENT_OPTIONS_REDIRECT_URI`

See [GitLab documentation](https://docs.gitlab.com/ee/administration/auth/oidc.html) for more details.
...
##### `OAUTH2_OPENID_RESPONSE_TYPE`

Defaults to `code`.

##### `OAUTH2_OPENID_ISSUER` (optional)
...
##### `OAUTH2_OPENID_CLIENT_AUTH_METHOD` (optional)
...
##### `OAUTH2_OPENID_UID_FIELD` (optional)
...
##### `OAUTH2_OPENID_SEND_SCOPE_TO_TOKEN_ENDPOINT`
...
##### `OAUTH2_OPENID_CLIENT_OPTIONS_IDENTIFIER`

The client identifier as configured in the OpenID Connect service provider.

##### `OAUTH2_OPENID_CLIENT_OPTIONS_SECRET`
...
##### `OAUTH2_OPENID_CLIENT_OPTIONS_REDIRECT_URI`
