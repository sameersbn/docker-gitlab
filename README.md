...
| `GITLAB_BACKUP_STRATEGY` | Set to `copy` to avoid `file changed as we read it` errors. [See](https://docs.gitlab.com/ee/raketasks/backup_restore.html#backup-strategy-option) |
