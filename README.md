...
# quay.io/sameersbn/gitlab:8.0.4-2
...
```bash
docker pull quay.io/sameersbn/gitlab:8.0.4-2
```
...
docker run --name gitlab -d [OPTIONS] \
    quay.io/sameersbn/gitlab:8.0.4-2 app:sanitize
```
...
```bash
docker run --name gitlab -it --rm [OPTIONS] \
    quay.io/sameersbn/gitlab:8.0.4-2 app:rake gitlab:backup:create
```
...
```bash
docker run --name gitlab -it --rm [OPTIONS] \
    quay.io/sameersbn/gitlab:8.0.4-2 app:rake gitlab:backup:restore
```
...
```bash
docker run --name gitlab -it --rm [OPTIONS] \
    quay.io/sameersbn/gitlab:8.0.4-2 app:rake gitlab:backup:restore BACKUP=1417624827
```
...
```bash
docker run --name gitlab -d [OPTIONS] \
    quay.io/sameersbn/gitlab:8.0.4-2 app:rake gitlab:env:info
```
...
```bash
docker run --name gitlab -d [OPTIONS] \
    quay.io/sameersbn/gitlab:8.0.4-2 app:rake gitlab:import:repos
```
...
```bash
docker run --name gitlab -d [OPTIONS] quay.io/sameersbn/gitlab:8.0.4-2
```
